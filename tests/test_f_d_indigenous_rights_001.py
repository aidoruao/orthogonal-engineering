"""Falsification tests for d_indigenous_rights"""
from src.domains.d_indigenous_rights import Entity, ComplianceStatus
...
if __name__ == "__main__":
    ...
    print("All d_indigenous_rights tests: PASS")
