...
ITERATIONS = 10_000
# Scaled by 10. CI/container jitter can inflate Welch t above 4.5 on shared runners.
# 5.5 keeps the falsification bar strict while avoiding frequent flaky failures.
T_THRESHOLD = 55
