...
CLAIMS = [
    ...
    ("campaign master exists", "file", OE / "OE_CAMPAIGN.md", None),
    ("audits readme exists", "file", OE / "AUDITS" / "README.md", None),
    ("transparency ledger exists", "file", OE / "TRANSPARENCY_LEDGER.md", None),
    ("census tool exists", "file", D / "model_census.py", None),
    ("census qwen3 exists", "file", D / "census" / "qwen3_235b_a22b.json", None),
    ("census kimi exists", "file", D / "census" / "kimi_k2_instruct.json", None),
    ("census report exists", "file", D / "CENSUS_REPORT.md", None),
    ("evasion scanner exists", "file", D / "evasion_scan.py", None),
    ("evasion report exists", "file", D / "evasion_scan_report.json", None),
    ("evasion catalog exists", "file", OE / "AUDITS" / "evasion_tactics.md", None),
    ("evasion countermeasures exists", "file", D / "EVASION_COUNTERMEASURES.md", None),
    ("evasion pairs rows", "count", D / "corporate_evasion_pairs.jsonl", 200),
    ("canonical v3 rows", "count", D / "canonical_sft_v3.jsonl", 7573),
    ("evasion stats exists", "file", D / "corporate_evasion_stats.json", None),
