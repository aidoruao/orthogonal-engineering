...
1. M2 dataset built + sha-verified; merged into canonical_sft_v2 lineage as `canonical_sft_v3` (v1/v2 untouched). **DONE 8/10 — 200 pairs, sha `9a9862bb…`; v3 = 7,573 rows sha `a517f1d1…`; double-run byte-identical.**
