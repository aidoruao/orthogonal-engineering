...
public class KeyedClientLevelManager implements IKeyedClientLevelManager {
    ...
    @Override
    public IServerKeyedClientLevel setServerKeyedLevel(IClientLevelWrapper clientLevel, String serverKey,
        String levelKey) {
        IServerKeyedClientLevel keyedLevel = new ServerKeyedClientLevel(
            (WorldClient) clientLevel.getWrappedMcObject(),
            serverKey,
            levelKey);
