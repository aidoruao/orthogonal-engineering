...
public abstract class AbstractModInitializer {
    ...
    protected <T extends IModAccessor> void tryCreateModCompatAccessor(String modId, Class<? super T> accessorClass,
        Supplier<T> accessorConstructor) {
    ...
    private static void logModIncompatibilityWarnings() {
        ...
        if (modChecker.isModLoaded("alexscaves")) {
            ...
            if (showChatWarnings) {
                String message =
                    // orange text
                    "\u00A76" + "Distant Horizons: Alex's Cave detected."
                        + "\u00A7r\n"
            ...
            LOGGER.warn(
                startingString
                    + "[Alex's Caves] may require some config changes in order to render Distant Horizons correctly.");
        }
