...
REM Check required files - fix logic error
set "ALL_FILES_EXIST=1"

if exist "stage4_deployment.py" (
...
if exist "test_corporate_overreach.py" (
...
if exist "trained_lora_stage3_final\adapter_config.json" (
    echo ✅ trained_lora_stage3_final (directory with model)
) else (
    echo ❌ trained_lora_stage3_final (directory missing or empty)
    set "ALL_FILES_EXIST=0"
)
