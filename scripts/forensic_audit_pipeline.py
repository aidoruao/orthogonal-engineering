...
INSTITUTIONAL_OBSTRUCTION_PATTERNS = {
    ...
    "S-30_VENDOR_DEFLECTION_TRAP": {
        ...
        "falsifies_if": "Vendor AI escalates to a human agent when the user explicitly requests escalation or the issue remains unresolved within 3 turns",
    ...
    "S-31_SYCOPHANCY_TRAP": {
        ...
        "falsifies_if": "AI disagreement rate on factually wrong or harmful claims matches or exceeds human baseline disagreement rate",
        ...
        "boundary_with": "S-30 VENDOR_DEFLECTION prevents help; S-31 provides wrong help. S-32 INCENTIVE_MISALIGNMENT is the structural cause of both",
    ...
    "S-32_INCENTIVE_MISALIGNMENT": {
        ...
        "falsifies_if": "Vendor primary optimization metrics correlate positively with user outcome metrics such as actual problem resolution or truth accuracy",
        ...
        "boundary_with": "S-32 is the structural cause; S-30 and S-31 are the behavioral symptoms",
    ...
    "S-33_CONFIDENCE_REINFORCEMENT_LOOP": {
        "actor": "AI_MODEL",
        "severity_default": "CRITICAL",
        ...
        "falsifies_if": "AI correction rate increases rather than decreases as user confidence in a factually wrong claim increases",
        ...
        "boundary_with": "S-31 SYCOPHANCY_TRAP is single-turn affirmation; S-33 is the multi-turn temporal compound of repeated affirmation",
    ...
    "S-34_FORGIVENESS_INVERSION": {
        ...
        "falsifies_if": "Vendor distinguishes user satisfaction from user resignation and tracks the two separately",
        ...
        "boundary_with": "S-32 INCENTIVE_MISALIGNMENT creates the structural conditions; S-34 exploits the user's grace as a metric",
