"""Falsification tests for THERMODYNAMICS."""

from dataclasses import replace
from fractions import Fraction

from ..implementation import create_nominal_claim
from ..invariants import check_entropy_increase, run_all_invariants
...
def test_failure_path_detected() -> None:
    ...
    failing_claim = replace(claim, entropy_increases=False)
    success, proof = check_entropy_increase(failing_claim)
