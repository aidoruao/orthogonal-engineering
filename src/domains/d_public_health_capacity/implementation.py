...
DOMAIN_METADATA = {
    ...
    "check_functions": [
        "check_icu_bed_density_ratio",
        "check_ventilator_reserve_ratio",
        "check_ppe_supply_ratio",
        "check_tracer_density_ratio",
        "check_lab_turnaround_fraction",
        "check_audit_staleness_fraction",
        "check_surveillance_coverage",
        "check_staff_training_ratio",
    ],
}
