...
DOMAIN_METADATA = {
    ...
    "check_functions": [
        "check_warning_latency_fraction",
        "check_evacuation_capacity_ratio",
        "check_fuel_reserve_ratio",
        "check_mutual_aid_coverage_ratio",
        "check_backup_power_fraction",
        "check_after_action_staleness_fraction",
        "check_cyber_readiness_score",
        "check_infrastructure_redundancy",
    ],
}
