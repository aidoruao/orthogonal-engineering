"""Falsification tests for D_ARXIV_STATML_BI_LIPSCHITZ."""

from dataclasses import replace
from fractions import Fraction

from ..implementation import create_nominal_claim
from ..invariants import check_injectivity, run_all_invariants
...
def test_failure_path_detected() -> None:
    ...
    failing_claim = replace(claim, is_injective=False)
    success, proof = check_injectivity(failing_claim)
