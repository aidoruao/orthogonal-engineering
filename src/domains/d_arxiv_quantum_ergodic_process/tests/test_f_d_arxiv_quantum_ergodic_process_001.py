"""Falsification tests for D_ARXIV_QUANTUM_ERGODIC_PROCESS."""

from dataclasses import replace
from fractions import Fraction

from ..implementation import create_nominal_claim
from ..invariants import check_ergodicity, run_all_invariants
...
def test_failure_path_detected() -> None:
    ...
    failing_claim = replace(claim, is_ergodic=False)
    success, proof = check_ergodicity(failing_claim)
