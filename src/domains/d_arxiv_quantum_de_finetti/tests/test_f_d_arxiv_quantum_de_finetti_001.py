"""Falsification tests for D_ARXIV_QUANTUM_DE_FINETTI."""

from dataclasses import replace
from fractions import Fraction

from ..implementation import create_nominal_claim
from ..invariants import check_exchangeability, run_all_invariants
...
def test_failure_path_detected() -> None:
    ...
    failing_claim = replace(claim, is_exchangeable=False)
    success, proof = check_exchangeability(failing_claim)
