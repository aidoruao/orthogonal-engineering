"""Falsification tests for D_ARXIV_CONTRACT_DEDUCTION."""
from dataclasses import replace
from fractions import Fraction
from ..implementation import create_nominal_claim
from ..invariants import check_contract_soundness, run_all_invariants
...
def test_failure_path_detected() -> None:
    ...
    failing_claim = replace(claim, is_sound=False)
    success, proof = check_contract_soundness(failing_claim)
