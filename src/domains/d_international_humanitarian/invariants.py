...
def check_distinction_principle() -> Tuple[bool, ProofObject]:
    ...
    falsifies_if: valid targets fail or invalid targets pass the distinction check.
    """
...
def check_proportionality() -> Tuple[bool, ProofObject]:
    ...
    falsifies_if: expected civilian harm exceeds permissible proportionality relative
...
def check_protection_of_civilians() -> Tuple[bool, ProofObject]:
    ...
    falsifies_if: protection status check fails for civilians or passes for
...
def check_medical_neutrality() -> Tuple[bool, ProofObject]:
    ...
    falsifies_if: medical personnel lack protection or incorrect category is set.
    """
...
def check_pow_rights() -> Tuple[bool, ProofObject]:
    ...
    falsifies_if: POW does not receive required protections or is misclassified.
    """
...
def check_compliance_deterministic() -> Tuple[bool, ProofObject]:
    ...
    falsifies_if: any international humanitarian law invariant check fails.
    """
    checks = [
