"""Falsification tests for TOPOLOGY."""

from dataclasses import replace
from fractions import Fraction

from ..implementation import create_nominal_claim
from ..invariants import check_compactness_preserved, run_all_invariants
...
def test_failure_path_detected() -> None:
    ...
    failing_claim = replace(claim, compactness_preserved=False)
    success, proof = check_compactness_preserved(failing_claim)
