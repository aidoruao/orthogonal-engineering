"""Falsification tests for ELECTRICAL_TRADES."""

from dataclasses import replace
from fractions import Fraction

from ..implementation import create_nominal_claim
from ..invariants import check_ohms_law_satisfied, run_all_invariants
...
def test_failure_path_detected() -> None:
    ...
    failing_claim = replace(claim, ohms_law_satisfied=False)
    success, proof = check_ohms_law_satisfied(failing_claim)
