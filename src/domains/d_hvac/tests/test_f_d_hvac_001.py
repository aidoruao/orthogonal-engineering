"""Falsification tests for HVAC."""

from dataclasses import replace
from fractions import Fraction

from ..implementation import create_nominal_claim
from ..invariants import check_heat_load_calculated, run_all_invariants
...
def test_failure_path_detected() -> None:
    ...
    failing_claim = replace(claim, heat_load_calculated=False)
    success, proof = check_heat_load_calculated(failing_claim)
