"""Falsification tests for D_ARXIV_GOODSTEIN."""

from dataclasses import replace
from fractions import Fraction

from ..implementation import create_nominal_claim
from ..invariants import check_termination, run_all_invariants
...
def test_failure_path_detected() -> None:
    ...
    failing_claim = replace(claim, terminates=False)
    success, proof = check_termination(failing_claim)
