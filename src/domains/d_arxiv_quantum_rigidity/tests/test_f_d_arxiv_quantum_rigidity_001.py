"""Falsification tests for D_ARXIV_QUANTUM_RIGIDITY."""
from dataclasses import replace
from fractions import Fraction
from ..implementation import create_nominal_claim
from ..invariants import check_rigidity, run_all_invariants
...
def test_failure_path_detected() -> None:
    ...
    failing_claim = replace(claim, is_rigid=False)
    success, proof = check_rigidity(failing_claim)
