"""Falsification tests for D_ARXIV_ENRICHED_COALGEBRA."""

from dataclasses import replace
from fractions import Fraction

from ..implementation import create_nominal_claim
from ..invariants import check_comonadicity, run_all_invariants
...
def test_failure_path_detected() -> None:
    ...
    failing_claim = replace(claim, is_comonadic=False)
    success, proof = check_comonadicity(failing_claim)
