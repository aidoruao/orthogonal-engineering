"""Falsification tests for RELIABILITY_ENGINEERING."""

from dataclasses import replace
from fractions import Fraction

from ..implementation import create_nominal_claim
from ..invariants import check_mtbf_positive, run_all_invariants
...
def test_failure_path_detected() -> None:
    ...
    failing_claim = replace(claim, mtbf_positive=False)
    success, proof = check_mtbf_positive(failing_claim)
