"""Falsification tests for D_ARXIV_FACTORIALITY."""
from dataclasses import replace
from fractions import Fraction
from ..implementation import create_nominal_claim
from ..invariants import check_ufd_property, run_all_invariants
...
def test_failure_path_detected() -> None:
    ...
    failing_claim = replace(claim, is_ufd=False)
    success, proof = check_ufd_property(failing_claim)
