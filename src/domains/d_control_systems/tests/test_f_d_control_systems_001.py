"""Falsification tests for CONTROL_SYSTEMS."""

from dataclasses import replace
from fractions import Fraction

from ..implementation import create_nominal_claim
from ..invariants import check_stability_lyapunov, run_all_invariants
...
def test_failure_path_detected() -> None:
    ...
    failing_claim = replace(claim, lyapunov_stable=False)
    success, proof = check_stability_lyapunov(failing_claim)
