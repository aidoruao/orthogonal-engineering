"""Falsification tests for D_ARXIV_STATML_CONFORMAL_MARGIN."""

from dataclasses import replace
from fractions import Fraction

from ..implementation import create_nominal_claim
from ..invariants import check_robustness, run_all_invariants
...
def test_failure_path_detected() -> None:
    ...
    failing_claim = replace(claim, is_robust=False)
    success, proof = check_robustness(failing_claim)
